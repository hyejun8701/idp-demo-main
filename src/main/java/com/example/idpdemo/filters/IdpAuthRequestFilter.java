...
public class IdpAuthRequestFilter extends SamlFilter {
    RequestMatcher requestMatcher = new AntPathRequestMatcher("/**/SSO/alias/firb", HttpMethod.GET.name());
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (requestMatcher.matches(request) &&
            ...
            assertion.addAttribute(new Attribute().setName("email").setValues(Collections.singletonList(user.getEmail())));
